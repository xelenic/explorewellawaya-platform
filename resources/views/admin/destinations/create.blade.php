...
<div class="page-header">
    ...
    <div class="breadcrumb"><a href="{{ route('admin.destinations.index') }}">Destinations</a> / Create</div>
</div>
...
<div class="card">
    ...
    <form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="category" name="category" value="{{ old('category') }}" placeholder="e.g., Nature, Cultural, Adventure" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="images" name="images" value="{{ old('images') }}" placeholder="https://example.com/img1.jpg, https://example.com/img2.jpg">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="highlights" name="highlights" rows="5" placeholder="Key features or attractions">{{ old('highlights') }}</textarea>
        </div>
        
        <div class="form-group">
            <label class="form-label" for="best_time_to_visit">Best Time to Visit</label>
            <input type="text" class="form-control" id="best_time_to_visit" name="best_time_to_visit" value="{{ old('best_time_to_visit') }}" placeholder="e.g., December to February">
        </div>
        
        <div class="form-group">
            <label class="form-label" for="how_to_reach">How to Reach</label>
            <textarea class="form-control" id="how_to_reach" name="how_to_reach" rows="5" placeholder="Transportation options and directions">{{ old('how_to_reach') }}</textarea>
        </div>
        
        <div class="form-group">
            <label class="form-label" for="tips">Tips</label>
            <textarea class="form-control" id="tips" name="tips" rows="4" placeholder="Travel tips and recommendations">{{ old('tips') }}</textarea>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
            <div class="form-group">
                ...
                <input type="number" step="any" class="form-control" id="latitude" name="latitude" value="{{ old('latitude') }}" placeholder="-90 to 90">
            </div>
            
            <div class="form-group">
                <label class="form-label" for="longitude">Longitude</label>
                <input type="number" step="any" class="form-control" id="longitude" name="longitude" value="{{ old('longitude') }}" placeholder="-180 to 180">
            </div>
        </div>
...
<script>
    ...
    // Default center (Wellawaya, Sri Lanka)
    const defaultLat = {{ old('latitude', 6.7300) }};
    const defaultLng = {{ old('longitude', 81.1025) }};
